...
const BottomSheetFooterContainerComponent = ({ footerComponent: FooterComponent, }) => {
    //#region hooks
    const { animatedContainerHeight, animatedHandleHeight, animatedFooterHeight, animatedPosition, animatedKeyboardState, animatedKeyboardHeightInContainer, } = useBottomSheetInternal();
    //#endregion
    //#region variables
    ...
    //#endregion
    return React.createElement(FooterComponent, { animatedFooterPosition: animatedFooterPosition });
};
