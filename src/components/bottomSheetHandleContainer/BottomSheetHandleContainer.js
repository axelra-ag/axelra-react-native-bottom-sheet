...
function BottomSheetHandleContainerComponent({ animatedIndex, animatedPosition, simultaneousHandlers: _internalSimultaneousHandlers, enableHandlePanningGesture, handleHeight, handleComponent: _providedHandleComponent, handleStyle: _providedHandleStyle, handleIndicatorStyle: _providedIndicatorStyle, customIndicatorComponent, }) {
    //#region hooks
    const { activeOffsetX, activeOffsetY, failOffsetX, failOffsetY, waitFor, simultaneousHandlers: _providedSimultaneousHandlers, } = useBottomSheetInternal();
    ...
    //#endregion
    //#region renders
    const HandleComponent = _providedHandleComponent === undefined
        ? BottomSheetHandle
        : _providedHandleComponent;
    return HandleComponent !== null ? (React.createElement(GestureDetector, { gesture: panGesture },
        React.createElement(Animated.View, { key: "BottomSheetHandleContainer", onLayout: handleContainerLayout, style: styles.container },
            React.createElement(HandleComponent, { animatedIndex: animatedIndex, animatedPosition: animatedPosition, style: _providedHandleStyle, indicatorStyle: _providedIndicatorStyle, customIndicatorComponent: customIndicatorComponent })))) : null;
    //#endregion
}
