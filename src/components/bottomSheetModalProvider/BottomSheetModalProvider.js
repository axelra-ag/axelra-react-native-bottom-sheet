...
const BottomSheetModalProviderWrapper = ({ children, }) => {
    ...
    //#endregion
    //#region renders
    return (React.createElement(BottomSheetModalProvider, { value: externalContextVariables },
        React.createElement(BottomSheetModalInternalProvider, { value: internalContextVariables },
            React.createElement(BottomSheetContainer, { containerOffset: animatedContainerOffset, containerHeight: animatedContainerHeight, children: null }),
