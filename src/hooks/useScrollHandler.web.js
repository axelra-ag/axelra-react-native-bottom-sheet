...
export const useScrollHandler = () => {
    ...
    //#endregion
    //#region hooks
    const { animatedScrollableState, animatedAnimationState, animatedScrollableContentOffsetY, } = useBottomSheetInternal();
    //#endregion
    //#region effects
    useEffect(() => {
        const element = getRefNativeTag(scrollableRef);
        var scrollOffset = 0;
